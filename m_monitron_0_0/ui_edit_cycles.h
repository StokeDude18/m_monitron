...
public:
    ...
    QLineEdit *tb_Cycle2_3;
    QLabel *l_Cycle1_2;
    QLineEdit *tb_Cycle2_4;
    QLineEdit *tb_Cycle1_3;
    QLabel *l_Setpoint_Cycle_3;
    QLabel *l_Cycle2_2;
    QLineEdit *tb_Cycle1_4;
    ...
    void setupUi(QDialog *edit_Cycles)
    {
        ...
        tb_Cycle2_3 = new QLineEdit(edit_Cycles);
        tb_Cycle2_3->setObjectName(QStringLiteral("tb_Cycle2_3"));
        tb_Cycle2_3->setGeometry(QRect(360, 190, 141, 22));
        l_Cycle1_2 = new QLabel(edit_Cycles);
        l_Cycle1_2->setObjectName(QStringLiteral("l_Cycle1_2"));
        l_Cycle1_2->setGeometry(QRect(30, 110, 61, 16));
        l_Cycle1_2->setFont(font);
        tb_Cycle2_4 = new QLineEdit(edit_Cycles);
        tb_Cycle2_4->setObjectName(QStringLiteral("tb_Cycle2_4"));
        tb_Cycle2_4->setGeometry(QRect(95, 190, 141, 22));
        tb_Cycle1_3 = new QLineEdit(edit_Cycles);
        tb_Cycle1_3->setObjectName(QStringLiteral("tb_Cycle1_3"));
        tb_Cycle1_3->setGeometry(QRect(360, 110, 141, 22));
        l_Setpoint_Cycle_3 = new QLabel(edit_Cycles);
        l_Setpoint_Cycle_3->setObjectName(QStringLiteral("l_Setpoint_Cycle_3"));
        l_Setpoint_Cycle_3->setGeometry(QRect(260, 190, 96, 16));
        l_Setpoint_Cycle_3->setFont(font);
        l_Cycle2_2 = new QLabel(edit_Cycles);
        l_Cycle2_2->setObjectName(QStringLiteral("l_Cycle2_2"));
        l_Cycle2_2->setGeometry(QRect(30, 190, 61, 16));
        l_Cycle2_2->setFont(font);
        tb_Cycle1_4 = new QLineEdit(edit_Cycles);
        tb_Cycle1_4->setObjectName(QStringLiteral("tb_Cycle1_4"));
        tb_Cycle1_4->setGeometry(QRect(95, 110, 141, 22));
        l_Setpoint_Cycle_4 = new QLabel(edit_Cycles);
        l_Setpoint_Cycle_4->setObjectName(QStringLiteral("l_Setpoint_Cycle_4"));
        l_Setpoint_Cycle_4->setGeometry(QRect(260, 110, 96, 16));
        ...
        cb_Cycle_Mode_Toggle->setGeometry(QRect(15, 50, 221, 22));
