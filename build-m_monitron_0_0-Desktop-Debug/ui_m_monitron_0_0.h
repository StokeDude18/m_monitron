...
public:
    ...
    void setupUi(QMainWindow *m_monitron_0_0)
    {
        ...
        l_Lecture->setGeometry(QRect(20, 30, 166, 46));
        QFont font2;
        ...
        l_Taux_Var->setGeometry(QRect(20, 175, 266, 46));
        ...
        l_Current_Setpoint->setGeometry(QRect(305, 115, 86, 36));
        QFont font3;
        ...
        l_Current_Var_Rate->setGeometry(QRect(305, 185, 86, 31));
        l_Current_Var_Rate->setFont(font3);
        label = new QLabel(t_Lecture);
        label->setObjectName(QStringLiteral("label"));
        label->setGeometry(QRect(305, 40, 91, 36));
        label->setFont(font3);
        ...
        l_Cycle_Mode_State->setGeometry(QRect(20, 25, 341, 46));
        ...
        l_Cycle_Mode_Current_State->setGeometry(QRect(380, 30, 86, 41));
        ...
        l_Lecture_mV->setGeometry(QRect(20, 20, 211, 36));
        ...
        l_Val_Convertie->setGeometry(QRect(20, 75, 256, 31));
        QFont font8;
        ...
        l_COntrol_Range->setGeometry(QRect(20, 20, 161, 31));
        QFont font9;
        ...
        l_Alarm_Range->setGeometry(QRect(20, 60, 241, 31));
        l_Alarm_Range->setFont(font1);
        ...
        l_Current_Operation_Mode->setFont(font11);
        ...
        l_Current_Gloabal_Operation_Mode->setFont(font11);
