...
public:
    ...
    void setupUi(QMainWindow *m_monitron_0_0)
    {
        ...
        l_Cycle_Mode_State->setGeometry(QRect(20, 40, 101, 16));
        l_Cycle_Mode_State->setFont(font);
        ...
        l_Current_Cycle_1->setGeometry(QRect(90, 110, 67, 17));
        QFont font2;
        font2.setPointSize(14);
        font2.setBold(true);
        font2.setItalic(false);
        font2.setWeight(75);
        l_Current_Cycle_1->setFont(font2);
        l_Current_Cycle_2 = new QLabel(t_Cycles);
        l_Current_Cycle_2->setObjectName(QStringLiteral("l_Current_Cycle_2"));
        l_Current_Cycle_2->setGeometry(QRect(90, 190, 67, 17));
        l_Current_Cycle_2->setFont(font2);
        ...
        l_Current_Cycle_Setpoint_1->setGeometry(QRect(340, 110, 67, 17));
        l_Current_Cycle_Setpoint_1->setFont(font2);
        ...
        l_Current_Cycle_Setpoint_2->setGeometry(QRect(340, 190, 67, 17));
        l_Current_Cycle_Setpoint_2->setFont(font2);
        ...
        l_Cycle_Mode_Current_State->setGeometry(QRect(125, 40, 46, 17));
        l_Cycle_Mode_Current_State->setFont(font1);
        ...
        l_P1_Convert_Unit->setFont(font5);
        ...
        l_P2_Convert_Unit->setFont(font5);
    ...
    void retranslateUi(QMainWindow *m_monitron_0_0)
    {
        ...
        l_Cycle_Mode_State->setText(QApplication::translate("m_monitron_0_0", "Start Cycles: ", 0));
